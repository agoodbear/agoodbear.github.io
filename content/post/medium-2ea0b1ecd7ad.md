---
title: "73歲男性，胸痛持續。需要導管介入嗎?"
date: "2023-05-08"
draft: false
toc: false
thumbnail: "https://cdn-images-1.medium.com/max/1024/1*WPqDirWKj_yqdGzdBAZqnw.png"
categories:
  - "ecg"
  - "medium"
tags:
  - "medium-import"
medium_id: "2ea0b1ecd7ad"
medium_url: "https://medium.com/@agoodbear/73%E6%AD%B2%E7%94%B7%E6%80%A7-%E8%83%B8%E7%97%9B%E6%8C%81%E7%BA%8C-%E9%9C%80%E8%A6%81%E5%B0%8E%E7%AE%A1%E4%BB%8B%E5%85%A5%E5%97%8E-2ea0b1ecd7ad"
canonicalURL: "https://medium.com/@agoodbear/73%E6%AD%B2%E7%94%B7%E6%80%A7-%E8%83%B8%E7%97%9B%E6%8C%81%E7%BA%8C-%E9%9C%80%E8%A6%81%E5%B0%8E%E7%AE%A1%E4%BB%8B%E5%85%A5%E5%97%8E-2ea0b1ecd7ad"
---
### 73歲男性，胸痛持續。需要導管介入嗎?
...
![Fig.1 Initial ECG](https://cdn-images-1.medium.com/max/1024/1*T52E6q5yGpWZPMwfY9lqAw.png)
***Fig.1 Initial ECG***
...
![Fig.2 AMI Definition](https://cdn-images-1.medium.com/max/1024/1*8NJSL_CXDZJ7zDIbUOXGSw.png)
***Fig.2 AMI Definition***

AMI就是出現**Myocardial injury的證據(Biomarker上升)+ Myocardial ischemia證據(症狀 or ECG or 影像出問題)。(Fig.2)**

而要診斷STEMI，則必須符合STEMI criteria。(**Fig.3**)

![Fig.3 STEMI criteria](https://cdn-images-1.medium.com/max/1024/1*Sp7uErs0kp0vKimzbzqcRQ.png)
...
1. 這也代表著，隨便抓一個人來作12 lead ECG，很有可能會在V2/V3都看到有STE，只是有沒有意義的高，就需要根據上述的criteria了。
...
![Fig.4 Downsloping STD vs. Shelf-like STD](https://cdn-images-1.medium.com/max/1024/0*M00QyDT0XGK9XLe0)
***Fig.4 Downsloping STD vs. Shelf-like STD***

### Back to Case

在**Fig.1**當時我看到在V2/V3似乎有出現downsloping STD，不過Baseline並不是很穩，但是如果光看V2，三個beat似乎都有。
...
[![Fig.5 ischemic pattern STE](https://cdn-images-1.medium.com/max/1024/1*dosDfg6w8Pe-zSs6HSgmqg.png)](https://ecgwaves.com/topic/ecg-st-elevation-segment-ischemia-myocardial-infarction-stemi/)
...
![Fig.6](https://cdn-images-1.medium.com/max/1024/1*_H64Mr6oD-FGA0tX2tJUuA.png)
*Fig.6*
...
![Fig.7 PSAX的papillary muscle view](https://cdn-images-1.medium.com/max/1024/1*kD6wqCZCbFd224Z2bUTpRQ.gif)
***Fig.7 PSAX的papillary muscle view***

這個echo finding符合ECG缺血的區域。

另外病患也有在前一班做了Chest CTA去排除主動脈剝離。

![Fig.8 Static image of Chest CTA](https://cdn-images-1.medium.com/max/1024/1*OIBfO5McKY5eL0_NMCw_5A.png)
***Fig.8 Static image of Chest CTA***

Fig.8可以看到在Chest CTA下lateral wall of LV，比較偏向外側區塊有hypoperfusion(這也就是下面會說到的**myocardial perfusion defect**)的狀況(紅色偏暗區塊)。這也符合ECG與echo的findings。
...
3. 雖然使用ECG-gated MDCT影像對各種心臟疾病的成像效果較佳，但通常在non-ECG-gated contrast-enhanced CT也能提供足夠的信息，以識別一些意外發現的心臟異常，例如可能與患者主訴症狀有關的myocardial perfusion defect(MPD)。
4. Cardiac motion artifacts仍然是影響non-ECG-gated contrast-enhanced CT診斷ACS的最大因子
5. 出現myocardial perfusion defect但是卻沒有myocardial ischemia，主要是因為cardiac motion artifacts導致(false-positive →**假陽性**)，這種狀況的frequency只有15–20%，並不高。
6. 另外在ACS個案中，因為AMI降低了局部myocardial wall motion，也會促使cardiac motion artifacts的降低，並且讓心肌邊界更清楚(**這是壞事也是好事XD**)

![Fig.9](https://cdn-images-1.medium.com/max/1024/1*cgC7WdAdHJmtorghnSo80g.png)
***Fig.9***
...
1. ECG在inf.leads有HATW、straight ST segment(Checkmark sign+)，initial ECG出現downsloping STD in V2/V3
2. Echo顯示有RWMA在inf./lateral wall
3. Non-ECG-gated contrast enhanced CT出現myocardial perfusion defect
...
![Fig.10](https://cdn-images-1.medium.com/max/1024/0*VWSqJBY7zSpOJffz)
***Fig.10***
...
1. 在STEMI/NSTEMI paradigm，病患有缺血症狀並且ECG並不符合STEMI criteria，此時會進行serial F/U ECG➡但是**STEMI criteria對於ACO的sensitivity不高**(意思是病患血管有阻塞，但是會以STE表現出來的狀況不多，有更多是以非STE的ECG pattern來表現)
2. STEMI(-)/OMI(+)的患者可能會多次接受心電圖檢查，這些檢查反覆顯示為 OMI的診斷(**就像我這個Case**)，但卻反覆未達到STEMI criteria➡**通常這些serial F/U ECG不會演變成符合STEMI criteria**，總是在最佳可以進行intervention的時機點過了才會有所變化(**靠!!!好奸詐XD**)
3. Serial ECG來尋找 STEMI criteria有可能會繼續錯失STEMI(-)/OMI(+)導致Delayed PCI
...
![Fig.11](https://cdn-images-1.medium.com/max/1024/1*xDoqNXGiiR85-4HbXo9w3g.png)
***Fig.11***
...
6. STEMI(-)/OMI(+)，通常不會演變成符合STEMI criteria的STEMI(+)/OMI(+)
...
[^4]: Collet, J.-P., Thiele, H., Barbato, E., Barthélémy, O., Bauersachs, J., Bhatt, D. L., Dendale, P., Dorobantu, M., Edvardsen, T., Folliguet, T., Gale, C. P., Gilard, M., Jobs, A., Jüni, P., Lambrinou, E., Lewis, B. S., Mehilli, J., Meliga, E., Merkely, B., … ESC Scientific Document Group. (2021). 2020 ESC Guidelines for the management of acute coronary syndromes in patients presenting without persistent ST-segment elevation. European Heart Journal, 42(14), 1289–1367. [https://doi.org/10.1093/eurheartj/ehaa575](https://doi.org/10.1093/eurheartj/ehaa575)
[^5]: Dr. Smith’s ECG Blog: 50 year old with acute chest pain, with ‘normal’ ECG and falling troponin — [link](http://hqmeded-ecg.blogspot.com/2023/04/50-year-old-with-acute-chest-pain-with.html)
