---
title: "59歲男性、胸痛、劇烈背痛" #輸入這篇的title
date: "2026-03-01" #輸入時間
description: "59歲男性胸痛個案 ECG 解析：從 Wellens' syndrome、pseudonormalization of T wave、inverted U wave，到 ischemic pattern PVC，整理 STEMI(-)/OMI(+) 的臨床警訊。"
draft: false #若為false就會直接刊出，不會以草稿模式運作
featured: false #若設定為true，會設定為精選文章
toc: false #自動產生TOC
thumbnail: "/images/ipic/ecg-post-16-thumbnail.webp" #每篇文章的縮圖位置在這裡(static/images/)-變更
...
{{< ecg-wave-text level="2" >}}今天我們來看一個很有趣的個案。心電圖有很多可以學習的地方。{{< /ecg-wave-text >}}

59歲男性，大年初一來急診就醫。
這病患和我說胸痛已經痛了3-4天了，偶爾痛到後背。
今晚痛到後背，痛到冒冷汗

![ER arrival](../../static/images/ipic/ecg-post-16-er-arrival.png)
...
![](../../static/images/ipic/ecg-post-16-initial-ecg.png)
...
![Wellen vs. PE](../../static/images/ipic/ecg-post-16-wellens-vs-pe.png)
...
![Wellens syndrome](../../static/images/ipic/cleanshot-2026-03-01-at-15-15-22-2x.png)

#### 重點如下：

- 出現deeply TWI or biphasic TWI in V2-3(有可能會V1-V6都extend到) 
  - 記住: AIVR和出現TWI都有可能是reperfusion rhythm {{< tag-pill "ECG Tips" "mint" >}}
...
![Type 1 MI定義](../../static/images/ipic/cleanshot-2026-03-01-at-20-54-17-2x.png)
...
![再度返診](../../static/images/ipic/cleanshot-2026-03-01-at-21-27-42-2x.png)
...
![再次返診+30分鐘](../../static/images/ipic/cleanshot-2026-03-01-at-21-39-32-2x.png)

這張的T wave更高、且inverted U wave比再返診時的第一張更明顯

![放大Fig.7](../../static/images/ipic/cleanshot-2026-03-01-at-22-13-59-2x.png)
...
![](../../static/images/ipic/cleanshot-2026-03-01-at-22-33-59-2x.png)
...
![K:1.5](../../static/images/ipic/cleanshot-2026-03-01-at-22-45-40-2x.png)
...
![Inverted U wave](../../static/images/ipic/cleanshot-2026-03-01-at-22-54-12-2x.png)

好，那麼inverted U wave代表的臨床意義是什麼?有可能是**early sign with myocardial ischemia**

先來看看這篇2005的文章 [^4]

{{< imgrow cols="2" gap="14" >}}
{{< imgcol src="/images/ipic/cleanshot-2026-03-01-at-23-02-12-2x.png" alt="" caption="" >}}
{{< imgcol src="/images/ipic/cleanshot-2026-03-01-at-23-06-34-2x.png" alt="" caption="" >}}
{{< /imgrow >}}
...
![Inverted U wave](../../static/images/ipic/clean_Gemini_Generated_Image_bl5e3vbl5e3vbl5e.png)
...
![再度大痛的ECG strips](../../static/images/ipic/cleanshot-2026-03-02-at-11-45-39-2x.png)
...
![From Smith ECG Blog](https://cdn-images-1.medium.com/max/1024/0*QsTk0Pc3I5gPz8dc)
...
{{< imgrow cols="2" gap="14" >}}
{{< imgcol src="https://cdn-images-1.medium.com/max/1024/0*B2iJDLJNTOuty4q9" alt="" caption="" >}}
...
![CleanShot 2026-03-02 at 12.27.56@2x](../../static/images/ipic/cleanshot-2026-03-02-at-12-27-56-2x.png)

本來一開始我是將病患簽一般病房住院，後來看到這個ischemic pattern PVC，直接改床到CV-ICU住院
![](../../static/images/ipic/cleanshot-2026-03-02-at-12-32-25-2x.png)
...
![CAG findings](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2FER_Bear%2FTH-Qd0Loaf.jpg?alt=media&token=368e225d-784f-4a35-bcb9-ed1cc1755c01)
...
![ESC 2020 NSTEMI guideline](../../static/images/ipic/image-20260302124740951.png)
