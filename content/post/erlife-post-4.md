...
![健體比賽臺上的猙獰眼睛](../../static/images/ipic/erlife-post-4-16-bodybuilding-stage.jpg "證物自首：這就是我在臺上的「猙獰眼睛」。線條練得再好都被這雙眼睛敗光。")
...
![診所裡的眼鏡回收箱](../../static/images/ipic/erlife-post-4-12-glasses-bin.jpg "後來在診所看到這個——擺在門口的「大家丟掉的眼鏡」收集箱。我才意識到自己也快輪到了。")
...
| 保留度數 | 對焦點落在 | 對應場景 |
|---|---|---|
| 100 度 | 100 cm | 站著看病人本人 |
| **120 度** | **約 83 cm** | **看 monitor、處置距離** |
| **130 度** | **約 77 cm** | **手伸直一點看螢幕** |
| 150 度 | 約 67 cm | 看電腦螢幕 |
| 200 度 | 50 cm | 看書、寫病歷 |
| 300 度 | 約 33 cm | 手機、精細工作 |
...
- **1990 年代以後**：白內障手術換水晶體（IOL）開始套用 monovision 概念——慣用眼換看遠的水晶體、非慣用眼換看近的。
- **1990 年代起**：LASIK 雷射近視手術普及之後，monovision 移植到雷射上做「看遠 + 看近」配置。但傳統雷射 monovision 中距離有盲區、不適應率偏高。
- **2010 年前後**（首篇 LBV 臨床研究約 **2009-2011 年**發表）：英國倫敦 Vision Clinic 的 **Dan Reinstein** 醫師跟 Zeiss 合作，把「**誘導正向球面像差**」這個機制引進 monovision，讓兩眼景深各自延伸、在中距離產生融合帶——這就是 **LBV（Laser Blended Vision）的誕生**。
...
![仰望 101 大樓](../../static/images/ipic/erlife-post-4-09-101-tower.jpg)
...
![84 樓窗景配等待時的咖啡](../../static/images/ipic/erlife-post-4-10-coffee.jpg "診所裡也有免費飲料。84 樓窗景配著等待時的咖啡——奇妙的組合。")
...
![遠見眼科診所大門](../../static/images/ipic/erlife-post-4-08-clinic-door.jpg "第一次踏進遠見眼科診所大門。")

![84 樓窗景看出去的台北市](../../static/images/ipic/erlife-post-4-07-clinic-101-view.jpg "84 樓窗景：山、河、台北市，全部一覽無遺。")
...
![諮詢師重做一次完整檢查](../../static/images/ipic/erlife-post-4-13-consult.jpg)
...
![乾眼症 Schirmer test 中](../../static/images/ipic/erlife-post-4-14-dryeye.jpg)
...
- LBV 的成像融合原理
- 我這個度數預期的術後效果
- 兩隻眼睛分別會調整成什麼狀態（右眼歸零 / 左眼留 150 度負責看近——這是諮詢階段的初步配置）
...
![遠見眼科手術室從外往內拍](../../static/images/ipic/erlife-post-4-11-or-room.jpg "從手術室外面玻璃往內拍。最外層的玻璃應該是會自動變霧化的——平常透明、手術時霧化保護病人隱私。")
...
![手術完跟張聰麒院長合照](../../static/images/ipic/erlife-post-4-06-with-dr-zhang.jpg "手術完跟張院長合照。<b>2026.05.07</b>——這天之後我跟眼鏡的關係正式改變了。")
...
![退役的眼鏡放在大理石桌上](../../static/images/ipic/erlife-post-4-15-goodbye-glasses.jpg "戴了大半輩子的眼鏡，這次換它退役。")
...
目前每天早上醒來，眼睛比較模糊的狀況，**持續時間已經縮短很多**，大部分時間都算蠻清楚的。

夜晚**眩光的程度改善非常多**，另外**乾眼的程度也改善很多**。
