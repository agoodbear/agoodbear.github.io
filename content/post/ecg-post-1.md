...
![](https://miro.medium.com/v2/resize:fit:1400/1*WPqDirWKj_yqdGzdBAZqnw.png)
...
![Initial ECG](https://miro.medium.com/v2/resize:fit:1400/1*T52E6q5yGpWZPMwfY9lqAw.png)


垂直藍線是畫在J point。J point是用來評估是否有STE or STD的點。J point是QRS的結尾到ST segment的開頭。若是在Baseline以上就是STE，baseline以下就是STD。

我們要運用STEMI criteria就是要看根據J point的位置來判斷是否有STE，才能夠診斷STEMI。
在最近的2018年第四版的Universal Definition of Myocardial Infarction裡面就有清楚講明什麼是AMI。什麼可以叫做STEMI。

![AMI Definition](https://miro.medium.com/v2/resize:fit:1400/1*8NJSL_CXDZJ7zDIbUOXGSw.png)
...
![STEMI criteria](https://miro.medium.com/v2/resize:fit:1400/1*Sp7uErs0kp0vKimzbzqcRQ.png)
...
在這篇Smith ECG Blog有提到¹，**在V2 or V3有任何程度的STD，都必須考慮posterior OMI，直到證明不是為止**。特別是**downsloping STD**(符合前述，即使STD<0.5~1 mm都要特別小心)
...
![Downsloping STD vs. Shelf-like STD](https://miro.medium.com/v2/resize:fit:1400/0*M00QyDT0XGK9XLe0)
...
![ischemic pattern STE](https://miro.medium.com/v2/resize:fit:1400/1*dosDfg6w8Pe-zSs6HSgmqg.png)
...
![F/U ECG](https://miro.medium.com/v2/resize:fit:1400/1*_H64Mr6oD-FGA0tX2tJUuA.png)
...
![PSAX的papillary muscle view](https://miro.medium.com/v2/resize:fit:1400/1*kD6wqCZCbFd224Z2bUTpRQ.gif)
...
![Static image of Chest CTA](https://miro.medium.com/v2/resize:fit:1024/1*OIBfO5McKY5eL0_NMCw_5A.png)
...
![non-ECG-gated contrast CT to detect ACS](https://miro.medium.com/v2/resize:fit:1400/1*cgC7WdAdHJmtorghnSo80g.png)
...
![NSTE-ACS](https://miro.medium.com/v2/resize:fit:1400/0*VWSqJBY7zSpOJffz)
...
![NSTE-ACS若符合Very high risk feature，有多少去做PCI](https://miro.medium.com/v2/resize:fit:1400/1*xDoqNXGiiR85-4HbXo9w3g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/0*9gbBZMC0EcdSE4pi)
...
2. 這是STEMI，你相信嗎?. 來看看昨天夜班上班的一位個案。50歲男性，本來從事捕鰻苗的工作。 | by Tsao Jian-hsiung | Medium — [link](https://medium.com/@agoodbear/這是stemi-你相信嗎-3485bf8aafc3)
3. Yoshihara, S. (2022). Acute coronary syndrome on non-electrocardiogram-gated contrast-enhanced computed tomography. World Journal of Radiology, 14(2), 30–46. https://doi.org/10.4329/wjr.v14.i2.30
