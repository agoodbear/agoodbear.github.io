---
title: "第一次引體向上拉那麼多次" #輸入這篇的title
date: "2024-06-07" #輸入時間
description: "引體向上訓練紀錄，分享醫師健身日常與進步過程，作為自我訓練與習慣養成回顧。"
featured: false #若設定為true，會設定為精選文章
draft: false #若為false就會直接刊出，不會以草稿模式運作
toc: false #自動產生TOC
#featureImage: "/images/HUGO.png" #設定這篇文章首頁的圖片
thumbnail: "/images/workout-post-1.webp" #每篇文章的縮圖位置在這裡(static/images/)-變更
