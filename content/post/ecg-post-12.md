...
toc: false #自動產生TOC
thumbnail: "/images/ecg-post-12.png" #每篇文章的縮圖位置在這裡(static/images/)-變更
...
![ROSC後的ECG](../../static/images/ipic/laqfx4.png)
...
![PE ECG findings](../../static/images/ipic/bmnxat.png)
...
![調整後ECG](../../static/images/ipic/zrvpuv.png)
...
![PE ECG findings總表](../../static/images/ipic/az2jtn.png)
...
![Qr in V1成因](../../static/images/ipic/zexpjs.png)
...
![](../../static/images/ipic/tif1hp.png)

下圖是文章中的ECG例子

![Qr in V1 ECG case](../../static/images/ipic/yoi9j7.png)

這篇文章收集了151位疑似PE的病患，由兩位觀察者來判讀ECG。這151位中有75名確診為PE還多做echo、並且檢測TnI與pro-BNP數值。

![Frequency of ECG signs in PE+/PE-](../../static/images/ipic/ja3iln.png)

上表可以看到**Qr in V1與STposV1(指STE≧0.1 mV in V1) 具有很高的specificity(100%/99%)，其PPV(陽性預測值)也都很高(100%/94%)**。
...
![Chest CTA](../../static/images/ipic/3foz2c.png)
...
![第二期工程興建規模設計圖](../../static/images/ipic/krmz6q.png)
...
-  **熊評論:** **對於出血風險高的患者（例如，最近進行過重大手術的患者），更應如此**。對照本case病患，病患一週前才於他院進行子宮肌腺症手術。的確如果先打了rTPA，有非常高風險會出血。
  - 要打之前，靜下心來想想rTPA check list，再尋一遍是否有contraindication的存在與否。**不要只想要當英雄，打了變狗熊都有可能**。[rTPA仿單在這裡](https://www1.ndmctsgh.edu.tw/pharm/Home/GetInsertCFile?id=005ACT03)
- 當病患不明原因collapse，沒有太多證據顯示是肺栓塞，如果要打rTPA。首先自己要先cardiomegaly(**心臟要大**😅)，不然就等ECMO support，搶時間後，再行檢查排除其他問題。

![rTPA contraindication](../../static/images/ipic/846dzf.png)

**讓我們再來看看一篇ICM 2024 八月份的一篇文章**[^4]

![](../../static/images/ipic/qdo920.png)

這篇研究在比較**因肺栓塞(PE)接受VA-ECMO治療的患者，先前是否接受rTPA治療對其短期和長期結果的影響**。
...
![](../../static/images/ipic/468b6fe8.webp)
