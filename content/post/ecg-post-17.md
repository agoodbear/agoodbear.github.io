---
title: "明明在救 ACS，怎麼會是主動脈剝離？——兩個偽裝成 STEMI 的 Type A Aortic Dissection"
date: "2026-07-10"
description: "兩個一開始都當急性冠心症在救的病人，最後診斷都是 Type A 主動脈剝離。一個會講話、走 inferior STEMI；一個 ROSC 回來、還在跳 VT/Vf。從 ECG、導管室線索、bedside echo，談 aortic dissection 怎麼偽裝 ACS、又該怎麼提早抓。"
...
{{< ecg-wave-text level="2" >}}今天想一次講兩個 case。這兩個病人，一開始都走在 ACS 的診斷路上，我們也照著最標準的流程在救；但真正的兇手，從頭到尾都不在冠狀動脈，而在主動脈。{{< /ecg-wave-text >}}
...
![到院 ECG](../../static/images/ipic/ecg-post-17-er-arrival.png "Fig. 1. Case 1 到院第一張 12 導程 ECG")
...
![右側導程](../../static/images/ipic/ecg-post-17-rside.png "Fig. 2. 右側導程（Right side ECG）")

而且後來還出現了 3rd degree AV block（見 **Fig. 3**）。下壁梗塞合併房室阻滯一點都不奇怪，因為 RCA 大多也供應 AV node；這個病人 refractory 到 dopamine，最後還放了 TPM。

![去導管前的 ECG strip](../../static/images/ipic/ecg-post-17-avb-strip.png "Fig. 3. 去導管前的 ECG strip：complete AV block（AV dissociation）")
...
![Case 2 到院 ER arrival ECG](../../static/images/ipic/ecg-post-17-case2-er.png "Fig. 5. Case 2 到院（ROSC 後）的 ER arrival ECG")
...
<div style="max-width:340px;margin:1.2rem auto .4rem"><div style="position:relative;padding-bottom:177.78%;height:0;border-radius:10px;overflow:hidden"><iframe style="position:absolute;top:0;left:0;width:100%;height:100%;border:0" src="https://www.youtube.com/embed/hgz0zV8S2yo" title="Aortic Regurgitation — Medzcool" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div></div>
...
![AR 的 PLAX + color Doppler](../../static/images/ipic/ecg-post-17-ar-echo.png "Fig. 7. AR 的 PLAX＋color Doppler（severe AR，regurgitant jet 灌回左心室）；來源 Wikimedia Commons／CardioNetworks／AMC Echolab，CC BY-SA 3.0")
