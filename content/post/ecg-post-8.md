...
![ROSC後的第一張ECG](../../static/images/ipic/1leh54.png)

沒有辦法看到明顯P wave，分不清QRS的結尾在哪裡。所以QRS是寬還是窄?

![ROSC+10 mins](../../static/images/ipic/5rgb2z.png)
...
![文獻absctract](../../static/images/ipic/cajmao.png)
...
![文章中的Primary and Secondary outcomes](../../static/images/ipic/xzptqk.png)
...
![Vf終止/ROSC結果](../../static/images/ipic/x98phl.png)
...
![心導管檢查](../../static/images/ipic/ci9ppm.png)
...
![Serial TnI](../../static/images/ipic/ve17o4.png)

病患在ICU的第三天有一張ECG，有趣。

![Day 3 ECG](../../static/images/ipic/0sk467.png)
...
![Dr.Smith](../../static/images/ipic/d64oqc.png)
