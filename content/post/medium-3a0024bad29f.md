---
title: "43歲男性，胸痛、盜汗，這張ECG有問題嗎?"
date: "2022-08-17"
draft: false
toc: false
thumbnail: "https://cdn-images-1.medium.com/max/1024/1*j_dZY1RQ8S521jbC_KH1JA@2x.png"
categories:
  - "ecg"
  - "medium"
tags:
...
![Fig.1 入院時ECG](https://cdn-images-1.medium.com/max/1024/1*j_dZY1RQ8S521jbC_KH1JA@2x.png)
***Fig.1 入院時ECG***
...
Fig.2是在Smith ECG Blog上面的教學圖片的內容:[來源在這](http://hqmeded-ecg.blogspot.com/p/teaching-images.html)

![Fig.2](https://cdn-images-1.medium.com/max/1024/0*ftKdaPQyRh3qZjgH.png)
***Fig.2***
...
在Aslanger的Ten steps to or away from cath lab這篇文章中\[^1\]，第七個步驟寫到要注意subtle ECG finding(**Fig.3**)，看看有無細微的reciprocal change。

![Fig.3](https://cdn-images-1.medium.com/max/1024/0*s-Noi3qmrNR52SEI)
***Fig.3***

TWI in aVL(或是STD in aVL)就是inf.leads出現缺血變化(特別是Lead III)的reciprocal change。

aVL為何對應III?由**Fig.4**就可以知道I/II/III/aVR/aVL/aVF都在frontal plane上面III和aVL不是完全180度對立面，但是也有150度。所以III/aVL這兩個lead是最能互相反應彼此是否出現缺血變化的對應leads。

![Fig.4](https://cdn-images-1.medium.com/max/1024/1*Mp6vPNP0afthmJi3VCbX7g.png)
***Fig.4***
...
[![Fig.5](https://cdn-images-1.medium.com/max/1024/0*YErTRgE5gJFcY_Pu.jpg)](https://litfl.com/wp-content/uploads/2018/08/ECG-Anterolateral-AMI-STEMI-2.jpg)
***Fig.5***

延伸想想，ECG還有哪些leads也是處在這種對立面，可以反應彼此是否有缺血變化的呢?

1. V1與V6偶爾會互相reciprocal change →在Septal STEMI通常會有STD in V5-V6，這是因為reciprocal to V1
2. V7–9(Post.leads)和V1–3是互相對立面的leads

好的，又講到偏離主題過遠了。拉回來正題，HATW和TWI in aVL都可以視為early ischemia sign。也就是在STE出現之前，就可能先行出現的sign。

另一位心電圖大師[Jerry W. Jones](https://www.linkedin.com/in/jerry-w-jones-md-facep-faaem-6b677337/)，在一次的演講講到reciprocal change的概念，我把slide截圖如下(**Fig.6**):

![Fig.6](https://cdn-images-1.medium.com/max/1024/0*k6jNTCrvTGVyO3-W)
***Fig.6***
...
所以看到early ischemia sign出現了，記得別把病患擺離自己遠到天邊的位置。把病患放到頭一抬起來，眼睛就看得到的位置，如果順便on上ECG monitor，那麼這就是**急診老鳥必備標準起手式**。因為可能轉瞬之間，ST segment就要起飛了。

那麼有多少比例的inf.wall STEMI(OMI)與ant.wall STEMI(OMI)會出現此reciprocal change呢?

👉在Ant.wall STEMI約有50-70%有reciprocal change，意思也就是有30–50%不會看到reciprocal change(沒involved到I/aVL，就不會有) →所**以在ant.OMI病患不應該依賴有無reciprocal change出現來排除OMI。**
...
👉Inf.wall STEMI有接近99-100%(指aVL)會有reciprocal change\[^2\]

- 所以看到有『意義』的TWI in aVL →要立馬上緊發條，準備和AMI作戰
- 需注意看到Inf.wall STEMI，沒有合併reciprocal change STD over aVL，不代表就可以排除LAD occlusion(wraparound LAD)\[^3\]
...
另外在之前所講到的Aslanger文章\[^1\]，裡面有提到我們綜觀整個12 leads ECG在尋找reciprocal change時要特別注意，LBBB、LVH、WPW、inferior LV aneurysm、PPM通常baseline會有reciprocal STD而沒有缺血狀況。
...
![Fig.7](https://cdn-images-1.medium.com/max/1024/1*FuMnQC25tuUld-03EotRxQ@2x.png)
***Fig.7***

過了40分鐘，病患覺得好很多了(**Fig.8**)。

![Fig.8](https://cdn-images-1.medium.com/max/1024/1*8TRG4vk6cCEGRVGtkwVAFg@2x.png)
***Fig.8***
...
1. 12 leads ECG有哪些leads可能會有相對應的reciprocal change變化
2. ACO(acute coronary occlusion)引起的reciprocal change(例如:TWI in aVL)可能會在對側面出現STE之前就已經先出現。
3. 在inf.wall STEMI幾乎接近100%會出現aVL reciprocal change、而在ant.wall STEMI則是50–70%出現inf.leads reciprocal change，這取決於有沒有影響到high lateral leads。所以在inf.wall STEMI沒有出現aVL的reciprocal change，可能要多想想是不是有其他問題。
