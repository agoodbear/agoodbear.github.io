...
**Dr. Smith ECG transcripts-search RAG endpoint**
- 連結: https://ftnrvkvzzvlfvdqirhxq.supabase.co/functions/v1/ecg-smith-search
- 一句說明: 前幾天 batch 灌好的 26 條中英對照逐字稿 corpus，今天 /search 跨 5 corpus 比對就有它在背景一起跑。

**Codex 生圖嘉明湖醫療剖面圖 Firebase host**
- 連結: https://firebasestorage.googleapis.com/.../
- 一句說明: 今天另一條工作流——v6 → v7 → v8 嘉明湖 5 天醫療剖面圖迭代，原圖 1.8MB、Real-ESRGAN 4× 放大列印級 19MB，全掛在 Firebase 給 Roam 引用。

**Roam ER_Bear page（嘉明湖視覺化資產主頁）**
- 連結: https://roamresearch.com/#/app/ER_Bear/page/d31ebGDi-
- 一句說明: 剖面圖每版本的 Codex prompt、Firebase URL、OBSOLETE 標記都記在這頁，方便日後 trace 哪一版才是 active、哪一版被新版本取代。
